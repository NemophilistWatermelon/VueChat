...
const routerContro = {
    ...
    getMsgContent: async (req, res, next) => {
        ...
        var select = `select * from utofCmsg where uid=${uid} and fid = ${fid} ORDER BY stime desc`;
        var select_2 = `select * from utofCmsg where uid = ${uid} ORDER BY stime desc`
